...
#'
#' @description VG250 product provided by the Federal Agency for Cartography and Geodesy, Germany
#'
#' @format Simple feature collection of type MULTIPOLYGON with 10,978 features and 6 fields:
#' \describe{
...
#' }
#'
#' @note Last access: 2025-12-20
#' @note License: Data licence Germany – attribution – version 2.0
#' @note Copyright: GeoBasis-DE / BKG 2025 (modified)
#'
#' @source Data from the Federal Agency for Cartography and Geodesy (BKG):
#'   <https://daten.gdz.bkg.bund.de/produkte/vg/vg250-ew_ebenen_1231/aktuell/vg250-ew_12-31.utm32s.shape.ebenen.zip>
#'
#' @references Product page: <https://gdz.bkg.bund.de/index.php/default/verwaltungsgebiete-1-250-000-mit-einwohnerzahlen-stand-31-12-vg250-ew-31-12.html>
"vg250"
